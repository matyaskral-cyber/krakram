...
<p>Kratom není vhodný pro osoby mladší 18 let, těhotné ženy ani pro uživatele opioidních léků. Pravidelné každodenní užívání může vést k toleranci a závislosti. Vždy začínejte s malým množstvím (1–2 g) a vyčkejte na účinky před případným opakováním.</p>

<h2>Závěr</h2>
<p>Kratom je fascinující rostlina s bohatou historií. Klíčem k bezpečnému užívání je informovanost, zodpovědný přístup a respekt k vlastním hranicím. Máte-li jakékoliv dotazy, neváhejte nás kontaktovat — rádi poradíme.</p>
    `,
  },
  {
    ...
    readTime: 6,
    content: `
<p>Jednou z nejčastějších otázek nových zákazníků je: <em>„Jaký je vlastně rozdíl mezi těmi barvami?"</em> Pojďme si to vysvětlit jednoduše a srozumitelně.</p>

<h2>Jak vzniká rozdělení?</h2>
<p>Kratom se tradičně dělí podle barvy centrální žilky listu v době sklizně. Tato barva odráží zralost listu a do určité míry i jeho alkaloidové složení. Jde o orientační systém — alkaloidový profil se liší i v rámci jedné barvy podle regionu, sklizně a zpracování.</p>

<h2>Bílá žilka</h2>
<p>Listy s bílou žilkou se sklízejí v raném stadiu zralosti. Bílá žilka bývá spojována s energizujícím charakterem — uživatelé popisují zvýšení soustředění a motivace. Vhodná spíše na dopoledne.</p>

<h2>Zelená žilka</h2>
<p>Zelená žilka představuje střední zralost listu a je považována za nejuniverzálnější. Nabízí vyvážený profil bez extrémů — mírná stimulace i relaxace zároveň. Oblíbená volba pro nové uživatele.</p>

<h2>Červená žilka</h2>
<p>Červená žilka pochází ze zralých listů s nejvyšším obsahem alkaloidů. Je typicky spojována s uklidňujícím a relaxačním charakterem. Oblíbená ve večerních hodinách nebo při potřebě zklidnění.</p>

<h2>Jak vybrat?</h2>
<p>Pokud nevíte kudy začít, doporučujeme zelenou žilku. Je nejjemnější, nejuniverzálnější a poskytne vám dobrý základ pro srovnání s ostatními. Neváhejte se na nás obrátit — rádi poradíme na základě vašich konkrétních potřeb.</p>
    `,
  },
  {
...
<p>V ČR má kratom jasný právní rámec: je legální psychomodulační látkou, kterou smí prodávat pouze držitelé povolení, výhradně dospělým a s povinnými informacemi pro spotřebitele. Situaci průběžně sledujeme a v případě legislativních změn budeme zákazníky informovat.</p>
  ...
  },
  {
    ...
    readTime: 6,
    content: `
<p>Správné dávkování je klíčem k příjemnému a bezpečnému zážitku s kratomem. Platí základní pravidlo: <strong>méně je více</strong>, zvláště na začátku. Na naší pobočce vám s výběrem a dávkováním rádi osobně poradíme.</p>

<h2>Faktory ovlivňující dávku</h2>
<p>Optimální dávka závisí na několika proměnných: tělesná hmotnost, individuální citlivost, obsah jídla v žaludku, konkrétní odrůda a její alkaloidový profil. Proto nelze stanovit univerzální „správnou" dávku — každý si ji musí najít sám, postupně.</p>

<h2>Orientační dávkování</h2>
<ul>
  <li><strong>1–2 g</strong> — Nízká dávka, vhodná pro úplné začátečníky. Zjistěte, jak vaše tělo reaguje.</li>
  <li><strong>2–4 g</strong> — Střední dávka pro většinu uživatelů.</li>
  <li><strong>4–6 g</strong> — Vyšší dávka, doporučujeme až po zkušenostech s nižšími.</li>
  <li><strong>6+ g</strong> — Nedoporučujeme, zvyšuje riziko vedlejších účinků.</li>
</ul>

<h2>Jak začít?</h2>
<p>Začněte s 1–2 gramy na lačný žaludek nebo 2 hodiny po jídle. Vyčkejte 45–60 minut na nástup účinků. Necítíte-li nic výrazného, příště zkuste o 0,5 g více. Nikdy nenavyšujte dávku ve stejný den.</p>

<h2>Frekvence užívání</h2>
<p>Pro předcházení toleranci a závislosti doporučujeme nepřekračovat 2–3 užití týdně s přestávkami minimálně 2 dny mezi dávkami. Nikdy neužívejte kratom jako každodenní rutinu.</p>

<h2>Vedlejší účinky při předávkování</h2>
<p>Příliš vysoká dávka může způsobit nevolnost, závrať, bolest hlavy nebo zvracení. Tyto příznaky odezní, ale jsou nepříjemné. Prevencí je postupné zvyšování dávky.</p>
    `,
  },
  {
    slug: "kratom-vs-kava",
    title: "Kratom vs. káva: Co mají společného a čím se liší?",
    description:
      "Kratom a káva jsou příbuzné rostliny — ale jejich účinky i složení se zásadně liší. Porovnání pro zvídavé.",
    date: "2025-03-10",
